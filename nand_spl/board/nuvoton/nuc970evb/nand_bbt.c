...
#define printk(fmt, arg...) sysprintf(fmt, ##arg) //CWWeng add
...
int nand_scan_bbt(struct mtd_info *mtd, struct nand_bbt_descr *bd)
{
	...
	*/
	this->bbt = (uint8_t *)0xc00000; //CWWeng
	memset((void*)this->bbt,0,len); //CWWeng
	...
	*/
	buf = (uint8_t *)0xd00000; //CWWeng
	memset((void*)buf,0,len); //CWWeng
...
static int nand_create_default_bbt_descr(struct nand_chip *this)
{
	...
	*/
	bd = (struct nand_bbt_descr *)0xe00000;//CWWeng
	memset((void*)bd,0,sizeof(*bd));//CWWeng
